 ...
 * @author santi
 */
public class Referral_JL extends AbstractionLayerAI {
    ...
    public Referral_JL(UnitTypeTable a_utt) {
        this(a_utt, new AStarPathFinding());
    }
    
    
    public Referral_JL(UnitTypeTable a_utt, PathFinding a_pf) {
        super(a_pf);
        reset(a_utt);
    }
